    ...
    <>
      <div className="mt-[55px] lg:h-[627px] h-auto flex flex-col lg:flex-row gap-5 w-full items-start lg:items-center justify-between">
          ...
          <div className="flex flex-col items-center lg:w-[30%] w-1/3 justify-between gap-5 ml-0 lg:ml-9 max-h-[600px] overflow-y-auto">
            ...
            {singleProductImages?.images?.map((img, i) => (
              <div
                ...
                className={`flex h-[194px] w-[141px] items-center justify-center bg-plate-1 relative group shrink-0 cursor-pointer ${activeImage === img.url ? 'border-2 border-black' : ''}`}
              >
                <img
                  src={img.url}
                  alt={`img${i + 1}`}
            ...
            {isAdmin && (
              <div
                ...
                className="w-[150px] flex items-center justify-center h-[210px] bg-plate-1 cursor-pointer hover:bg-gray-200 transition-colors shrink-0"
              >
                {isUploading ? (
        ...
        <div className="flex flex-col mx-5 gap-2 w-full lg:w-1/2 ">
          ...
          <div className="h-[1px] w-[85%] bg-plate-8 my-3"></div>

          <div className="flex flex-col items-start justify-start text-[15px] font-normal text-plate-6">
          ...
          <div className="flex items-start justify-start gap-5 mx-auto w-full flex-col lg:flex-row">
            <div className="flex items-center justify-center gap-4 border-1 border-plate-2 h-[50px] lg:w-1/3 md:w-[90%] w-[98%] rounded-full">
          ...
          <div className="flex flex-col max-md:mt-4 gap-3 items-start justify-start">
            <div className="flex gap-5 items-center justify-start">
              <ShippingsIcon />
              <span className="text-[14px] font-normal text-plate-6">
