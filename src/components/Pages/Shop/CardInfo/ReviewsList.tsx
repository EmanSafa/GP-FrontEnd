                        ...
                        {Array.from({ length: 5 }, (_, i) => {
                          ...
                          return (
                            <FaStar
                              ...
                              color={
                                ratingValue <= (hoverRating || editForm.rating)
                                  ? 'var(--plate-8)'
                                  : '#e4e5e9'
                              }
                              size={20}
                        ...
                        <div className="flex">
                          {Array.from({ length: 5 }, (_, i) => (
                            <FaStar
                              key={i}
                              className={`w-3 h-3 ${
                                i < review.rating ? 'text-plate-4' : 'text-gray-300'
                              }`}
                            />
                          ))}
                        </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        ...
                        className="bg-plate-8 hover:bg-plate-7 text-white"
                      >
      ...
      {reviewsData?.pagination && reviewsData.pagination.totalPages > 1 && (
        <div className="flex justify-center mt-6 gap-2">
          ...
          <Button
            ...
            onClick={() => {
              const totalPages = reviewsData.pagination?.totalPages ?? page;
