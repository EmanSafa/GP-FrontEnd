...
const YouMightLike = ({ categoryId, brandId, currentProductId }: YouMightLikeProps) => {
  ...
  return (
    <div className="max-w-[85%] mx-auto">
      <h1 className="font-bold text-[30px] text-[#404040] ml-10 mt-10">You may also like...</h1>
      <div className="w-[90%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 ">
        {relatedProducts.map((product) => (
          <ProductCard
            ...
            oldPrice={parseFloat(product.price) + 200}
