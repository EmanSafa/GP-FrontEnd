...
export const navbarStyles = {
  ...
  searchBar: {
    desktop: {
      ...
      input: 'border px-4 py-2 border-black rounded-l-full w-full h-[2.5rem] focus:outline-none',
      button: 'bg-black flex items-center justify-center rounded-r-full h-[2.5rem] w-[4rem]', // rounded-full for pill shape
      iconSize: 20,
      placeholder: 'Search products...',
    },
    tablet: {
      container: 'flex items-center',
      input: 'border-2 px-2 py-1 border-black rounded-l-2xl w-[200px] h-[1.8rem]',
      button: 'bg-black flex items-center justify-center rounded-r-2xl h-[1.8rem] w-[3rem]',
      iconSize: 16,
      placeholder: 'Search...',
    },
    mobile: {
      container: 'bg-white flex items-center justify-center p-3 border-b',
      input: 'border-2 px-3 py-2 border-black rounded-l-2xl flex-1 max-w-md h-[2.2rem]',
      button: 'bg-black flex items-center justify-center rounded-r-2xl h-[2.2rem] w-[3rem] p-2',
      iconSize: 18,
      placeholder: 'Search...',
    },
  },
  ...
  actionIcons: {
    desktop: {
      container: 'flex items-center gap-3 justify-end',
  ...
  layout: {
    ...
    topBar: 'bg-gray-50/50 w-full justify-between px-2 md:px-5 flex items-center z-[60] relative',
    desktop: 'hidden xl:grid grid-cols-3 items-center px-10 bg-transparent pb-3 z-40 relative',
    tablet:
