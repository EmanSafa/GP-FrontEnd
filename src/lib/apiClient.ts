...
export const productsApi = {
  list: (params?: ProductParams) => axiosInstance.get(endpoints.products.list, { params }),
  ...
  search: (params: SearchParams) => axiosInstance.get(endpoints.search.query, { params }),
...
export const ordersApi = {
  checkout: (data: CheckoutData) => axiosInstance.post(endpoints.orders.checkout, data),
  singleOrder: (id: number) => axiosInstance.get(endpoints.orders.singleOrder(id)),
...
export const reviewsApi = {
  ...
  create: (id: number, data: ReivewData) => axiosInstance.post(endpoints.reviews.create(id), data),
  delete: (id: number) => axiosInstance.delete(endpoints.reviews.delete(id)),
  productReview: (id: number, params?: ProductReviewParams) =>
  ...
  update: (id: number, data: unknown) => axiosInstance.put(endpoints.reviews.update(id), data),
  helpful: (id: number, data: unknown) => axiosInstance.post(endpoints.reviews.helpful(id), data),
};
...
export const userApi = {
  update: (
    ...
    axiosInstance.put<UserProfileResponse>(endpoints.user.update(id), data),
  profile: (id: number): Promise<AxiosResponse<UserProfileResponse>> =>
  ...
  addProfilePic: (
    id: number,
    photo: File
  ): Promise<AxiosResponse<UserProfilePicMutationResponse>> => {
    const formData = new FormData();
    formData.append('photo', photo);
    return axiosInstance.post<UserProfilePicMutationResponse>(
      endpoints.user.addProfilePicture(id),
      formData,
      {
        headers: { 'Content-Type': 'multipart/form-data' },
      }
  ...
  getProfilePic: (id: number): Promise<AxiosResponse<UserProfilePic>> =>
    axiosInstance.get<UserProfilePic>(endpoints.user.getProfilePicture(id)),
  deleteProfilePic: (id: number): Promise<AxiosResponse<UserProfilePicMutationResponse>> =>
    axiosInstance.delete<UserProfilePicMutationResponse>(endpoints.user.deleteProfilePicture(id)),
};
...
export const productsAdminApi = {
  ...
  delete: (id: number) => axiosInstance.delete(endpoints.productsAdminApi.delete(id)),
  uploadImages: (id: number, data: File[]) => {
    const formData = new FormData();
    data.forEach((img) => {
      formData.append('images[]', img);
    });
    return axiosInstance.post(endpoints.productsAdminApi.uploadImages(id), formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
  },
  deleteImage: (id: number) => axiosInstance.delete(endpoints.productsAdminApi.deleteImage(id)),
...
export const categoriesAdminApi = {
  ...
  update: (id: number, data: CategoryFormData) => {
    ...
    return axiosInstance.post(endpoints.categoriesAdminApi.update(id), formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
  },
  delete: (id: number) => axiosInstance.delete(endpoints.categoriesAdminApi.delete(id)),
};
...
export const brandsAdminApi = {
  ...
  delete: (id: number) => axiosInstance.delete(endpoints.brandsAdminApi.delete(id)),
};
...
export const UserAdminApi = {
  ...
  delete: (id: number) => axiosInstance.delete(endpoints.userAdminApi.delete(id)),
};
