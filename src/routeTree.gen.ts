...
import { Route as AuthResetPassRouteImport } from './routes/auth/resetPass'
...
const AuthResetPassRoute = AuthResetPassRouteImport.update({
  id: '/resetPass',
  path: '/resetPass',
  getParentRoute: () => AuthRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/auth/resetPass': typeof AuthResetPassRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/auth/resetPass': {
      id: '/auth/resetPass'
      path: '/resetPass'
      fullPath: '/auth/resetPass'
      preLoaderRoute: typeof AuthResetPassRouteImport
      parentRoute: typeof AuthRouteRoute
    }
    '/auth/login': {
      id: '/auth/login'
